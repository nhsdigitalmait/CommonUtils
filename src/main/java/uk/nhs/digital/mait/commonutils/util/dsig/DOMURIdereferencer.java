 ...
 */
// $Id: DOMURIdereferencer.java 16 2016-04-07 08:28:18Z sfarrow $
    ...
    implements javax.xml.crypto.URIDereferencer
{
            ...
            throws URIReferenceException
    {
        ...
        try {
            ...
            javax.xml.transform.Transformer tx = TransformManager.getInstance().getTransformerFactory().newTransformer();
...
//        return nsdr;
    ...
    private void addAttributes(NodeSetDataResult r, Node n) {
        ...
        java.util.Arrays.sort(l, new uk.nhs.digital.mait.commonutils.util.dsig.CanonicalAttributeComparator());
