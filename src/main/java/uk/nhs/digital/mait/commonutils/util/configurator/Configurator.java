...
public abstract class Configurator {
    ...
    protected static Configurator init() {
        String configuratorClass = System.getProperty("uk.nhs.digital.mait.commonutils.util.configurator.class");
        if (configuratorClass == null) {
            configuratorClass = "uk.nhs.digital.mait.commonutils.util.configurator.DefaultSystemPropertiesConfigurator";
        }
        Configurator c = null;
        try {
