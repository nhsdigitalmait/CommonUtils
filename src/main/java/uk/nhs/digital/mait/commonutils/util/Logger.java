...
public class Logger {
    ...
    private static final SimpleDateFormat DATE_STRING_FORMAT = new SimpleDateFormat("yyyyMMddHHmmss");
    ...
    private Logger() {
        dateString = DATE_STRING_FORMAT.format(new Date());
    ...
    public static String getDate() { return DATE_STRING_FORMAT.format(new Date()); }
    ...
    public void log(Level l, String location, String message) {
        ...
        // Short term fix - for serious events output to stderr as well
        // This might be better done with a console logger
        if ( l == SEVERE || l == WARNING ) {
            System.err.println(l+": "+sb.toString());
        }
    }
